...
$pdf->Cell(120, 0, 'CONSULTA DEUDAS TRIBUTARIAS + T.I.M AL '.$fechaActual, 0, 1, 'C', 0, '', 8);
$pdf->Ln(3);
...
$html_propietario .= '<table align="center">
                     ...
                     $esPrimeraFila = true; // Bandera para imprimir la celda "Carpeta" solo una vez
...
$html_estado= '<table align="center">
            ...
            $pdf->Line(181, $pdf->getY(),90, $pdf->getY());
