...
$html_head='<table align="left" cellpadding="1"  >
                    ...
                    <th width="320">SISTEMA DE RECAUDACIÓN MUNICIPAL</th>
                     <th width="140"  align="left" border="0.1">Expediente: 754771 , ACUM</th> 
                    ...
                    <tr>
                     <th width="320"></th>
                      ...
                      <tr>
                     <th width="320"></th>
                       <th width="140"  align="left" border="0.1">CC: '.$numero_expediente1_asig.' </th> 
...
//pripetario
$pdf->SetX(8); 
$pdf->SetFont('helvetica', 'B', 6.5);  // Establecer el tamaño de letra a 8
$pdf->Cell(10, 2, '1. Identifiacion de deudor tributario ', 0, 1, 'L');
$pdf->Ln(1);
...
$textoLargo = 'PRIMERO.- ACUMULAR los expedientes señalados en el considerando primero del presente mandato, entendiéndose en adelante como uno solo bajo el expediente Nº <número del Expediente que acumula>-ACUM;

SEGUNDO.- TRABAR LA MEDIDA CAUTELAR DE EMBARGO DEFINITIVO EN FORMA DE RETENCIÓN, hasta por la suma de S/. '.$monto_asig.' (<monto de la deuda en letras>), sobre los bienes, valores y fondos en cuentas corrientes, depósitos, sobregiros, custodia y otros que tenga o pudiera tener el obligado <nombre del contribuyente>, con DNI <número de documento de identidad> en los bancos, entidades financieras tanto en sus oficinas principales, agencias, sucursales, en moneda nacional y/o extranjera, notificándose a los representantes legales de dichas instituciones para que cumplan con la medida y pongan a la orden y disposición de la Municipalidad de <Nombre de la Municipalidad>, las retenciones que efectúen hasta completar la suma señalada, bajo apercibimiento de doble pago, o de comunicar la imposibilidad de ésta en el plazo máximo de <número de días hábiles otorgados> días hábiles de notificada; sin perjuicio de realizar la diligencia de toma de dicho;

TERCERO.- REQUERIR al obligado <nombre del contribuyente>, con DNI <número de documento de identidad>, para que inmediatamente luego de notificada la presente, CUMPLA con CANCELAR la obligación tributaria materia del presente procedimiento de ejecución coactiva; bajo apercibimiento de proceder a la Ejecución Forzada de las Medidas Cautelares de Embargo trabadas, conforme a ley; notificándose. Firmado. <Nombre y Apellidos del Ejecutor Coactivo>, Ejecutor Coactivo; <Nombre y Apellidos del Auxiliar Coactivo>, Auxiliar Coactivo. Lo que notifico a usted conforme a ley.';
