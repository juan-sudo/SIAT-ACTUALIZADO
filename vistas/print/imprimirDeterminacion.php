...
$configuracion = ControladorConfiguracion::ctrConfiguracion();
$estado_cuenta =ModeloEstadoCuenta::mdlEstadoCuenta_Orden_pdf($datos);
...
$html_head='<table align="center" >
                    <tr>
                       <th width="560"><h2>RESOLUCIÓN DETERMINACIÓN N° '.$estado_cuenta[0]['Numero_Orden'].'-'.$anio_impresion.' GAT - MPLP</h2></th>
                    </tr>
...
$sector_1='<table align="left"><tr>
                       <th>Se requiere la concelacion de la deuda tributaria contenido en presente documento, en el plazo de 3 dias habiles contados 
                    ...
                    <tr>
                       <th><b>Motivo Determinante: Se ha verificado la existencia de una deuda de Arbitrios Municipales no cancelada dentro de los plazoz de ley</b>. 
                       </th>
                    </tr>
                    <tr>
                       <th><b>2. DETALLE DEUDA TRIBUTARIA:</b> De acuerdo a la Ordenanza Municipal N° 005-2017-MPLP/CM y Ordenanza Municipal N° 013-2018-MPLP/A. 
                       </th>
                    </tr>
             </table>';
...
$html_estado= '<table align="center">
            ...
            $html .= "<tr><th></th><th></th>";
            $html .= "<th><b>".$_POST['importe']."</b></th>";
            $html .= "<th><b>".$_POST['gasto']."</b></th>";
            $html .= "<th><b>".$_POST['subtotal']."</b></th>";
            $html .= "<th><b>".$_POST['tim']."</b></th>";
   
            $pdf->writeHTML($html, true, false, false, false, '');
            $pdf->Line(180, $pdf->getY(),60, $pdf->getY());
          
            $pdf->SetFont('helvetica', 'B', 9);  // Establecer el tamaño de letra a 8
            $pdf->MultiCell(0, 1, '', 0, 'L');
            $pdf->Cell(297, 0, 'T O T A L   D E U D A      S/.   =               '.$_POST['total'], 0, 1, 'C', 0, '', 0);
...
$sector_2='<table align="left">
                     ...
                     <tr>
                       <th align="left">&nbsp;&nbsp;- Ordenanza Municipal N° 005-2017-MPLP/CM
                       </th> 
                       <th align="left">&nbsp;&nbsp;&nbsp;&nbsp;- Ordenanza Municipal N° 013-2008-MPLP/A
                       </th>
                     </tr>
