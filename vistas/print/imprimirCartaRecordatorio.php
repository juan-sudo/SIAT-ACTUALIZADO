...
$tipo_tributo_asig=$_POST['tipoTributario']; 
...
//$anio_fiscal_asiganda=$_POST['anioFiscalg'];
...
$pdf->Cell(120, 0, 'CARTA DE RECORDATORIO DE PAGO N° 001-2025 GAT - MPLP', 0, 1, 'C');
//-----------------------
$pdf->Ln(2);
//pripetario
$pdf->SetX(8); 
...
// Obtener la fecha actual
$textoLargo = 'La presente es para saludarlo cordialmente, deseando bienestar y salud para usted y su familia; asimismo, reconociendo su compromiso con el cumplimiento de sus obligaciones '.$tipo_tributo_asig .', ello nos permite mejorar la prestación de los servicios que demandan todos los vecinos en favor del desarrollo de nuestro distrito.';
...
$pdf->Ln(2); // Salto de línea
// Obtener la fecha actual
$textoLargo = 'El motivo de la presente es informarle que el día '.$fecha_venci_asig.' vence el plazo para el pago de la '.$numero_cuota_asig.' cuota del Impuesto Predial del año '.$anio_fiscal_asig.' por un monto ascendente a S/ '.$_POST['totalTotalI'].'. Considerando su responsabilidad en el pago oportuno de sus tributos, le expedimos el presente detalle de su deuda;';
...
$pdf->Cell(10, 2, 'Atentamente ', 0, 1, 'L');
