...
$fila = ModeloEstadoCuenta::mdlPropietario_licencia_pdf_v($idlicencia);

$notificacion = ModeloEstadoCuenta::mdlGenerar_notificacion_v($idlicencia);
...
$html_propietario .='<table align="center" >
                     <tr  font-size: 8px;>
                       ...
                       <td border="0.1" width="200">Titular de la Licencia</td>
...
$html_propietario .='<td border="0.1" width="200" style="font-size:8px; color: black;"><font color="black">'.$fila['nombre_completo'].'</font></td>';
