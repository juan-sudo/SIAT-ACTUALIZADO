...
$concatenadoId=$_POST['concatenadoId'];  
$gastoTotal=$_POST['gasto'];  
$importeTotal=$_POST['importe'];  
$timTotal=$_POST['tim'];  
$totalTotal=$_POST['total'];  
...
//SU ESTADO DE CUENTA PARA ORDEN DE PAGO
$propietarios = ModeloEstadoCuenta::mdlPropietarios_pdf_ordenpagoadmi($concatenadoId);

$carpeta = ModeloEstadoCuenta::mdlcarpetasOrdenPago($concatenadoId);


$resultadoOrden =ModeloEstadoCuenta::mdlEstadoCuentaAdministracion($concatenadoId);
...
$html_head='<table align="left" >
                    ...
                    <th width="380">SISTEMA DE RECAUDACIÓN MUNICIPAL</th>
                     <th  align="center" border="0.1">'.$resultadoOrden[0]['Fecha_Registro'].'</th> 
                     
                     </tr>
                       <tr>
                     <th width="380"></th>
                     <th  align="center" style="background-color: #ffd439; " border="0.1"> &nbsp;Carpeta: '.$carpeta[0]['Codigo_Carpeta'].'</th> 
...
$html_head='<table align="center" >
                    <tr>
                    <th width="560"><h2>ORDEN DE PAGO N° '.$resultadoOrden[0]['numero_orden'].' GAT - MPLP</h2></th>';
              
               
$html_head.='</tr> </table>';
 $pdf->writeHTML($html_head, true, false, false, false, '');
...
$html_estado= '<table align="center">
            ...
            $nombre_im = !empty($row['Tipo_Tributo']) ? $row['Tipo_Tributo'] : 'Imp. Predial';

            $html= '<table align="center">';            
            foreach ($resultadoOrden as $row) {
               
                $html .= "<tr>";
             
              
                $html .= "<th>".$nombre_im."</th>";
                $html .= "<th>".$row['Anio']."</th>";
            ...
            $html .= "<th><b>". $importeTotal."</b></th>";
            $html .= "<th><b>".$gastoTotal."</b></th>";
            $html .= "<th><b>".$totalTotal."</b></th>";
            $html .= "<th><b>".$timTotal."</b></th>";
           ...
           $pdf->Cell(297, 0, 'T O T A L   D E U D A      S/.   =               '.$totalTotal, 0, 1, 'C', 0, '', 0);
